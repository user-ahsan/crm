                ...
                funnel.length === 0 ? (
                  ...
                  <div className="space-y-4">
                    {funnel.map((stage, i) => {
                      ...
                      const STAGE_BAR_COLORS = ['bg-blue-500', 'bg-yellow-500', 'bg-purple-500', 'bg-orange-500', 'bg-green-500', 'bg-red-500'];
                      return (
                        <div key={stage.name} className="space-y-1">
                          ...
                          <div className="h-4 w-full overflow-hidden rounded-full bg-muted">
                            <div
                              className={`h-full rounded-full transition-all ${STAGE_BAR_COLORS[i % STAGE_BAR_COLORS.length] || 'bg-primary'}`}
              ...
              <nav className="divide-y divide-border">
                {[
                  ...
                  return (
                    ...
                    >
                      <span className={`flex size-6 shrink-0 items-center justify-center rounded-md bg-muted ${action.color}`}>
              ...
              <div className="space-y-3">
                {dueToday.map((task) => (
                  ...
                  >
                    ...
                    {task.dueDate && <TaskTime dueDate={task.dueDate} />}
                  </div>
                ))}
              </div>
            )}
