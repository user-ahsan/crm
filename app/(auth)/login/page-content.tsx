  ...
  const handleSubmit = useCallback(
    async (e: FormEvent<HTMLFormElement>) => {
      ...
      try {
        ...
        /* Only allow relative paths or same-origin URLs — prevent open redirect */
        const isSafe = rawRedirect.startsWith('/') && !rawRedirect.startsWith('//') && !rawRedirect.startsWith('http');
        const redirectTo = isSafe ? rawRedirect : '/dashboard';
      ...
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-5" noValidate>
          ...
          {sessionExpired && (
            <div
              role="alert"
              className="rounded-xl bg-amber-50 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-900 px-4 py-3 text-sm font-medium text-amber-800 dark:text-amber-200"
            >
