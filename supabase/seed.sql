...
insert into public.contacts (id, name, email, phone, job_title, company_id, lead_ids, location, social_links, tags, notes) values
  ('00000000-0000-0000-0000-000000000020', 'John Davis',        'john.davis@acme.com',       '+1 (555) 123-4567', 'CTO',                   '00000000-0000-0000-0000-000000000001', ARRAY['00000000-0000-0000-0000-000000000010'], 'San Francisco, CA', ARRAY['https://linkedin.com/in/johndavis'],       ARRAY['decision-maker','tech'],       'Key decision maker at Acme Corp.'),
  ('00000000-0000-0000-0000-000000000021', 'Sarah Miller',      'sarah@globex.io',           '+1 (555) 234-5678', 'VP of Operations',       '00000000-0000-0000-0000-000000000002', ARRAY['00000000-0000-0000-0000-000000000011'], 'Toronto, ON',       ARRAY['https://linkedin.com/in/sarahmiller'],      ARRAY['operations','finance'],        'Primary contact at Globex.'),
  ('00000000-0000-0000-0000-000000000022', 'Dr. Michael Chen',  'michael@initech.com',        null,                'Chief Medical Officer',  '00000000-0000-0000-0000-000000000003', ARRAY['00000000-0000-0000-0000-000000000012'], 'Boston, MA',        ARRAY['https://linkedin.com/in/michaelchen'],      ARRAY['healthcare','decision-maker','compliance'], 'Oversees all tech decisions at Initech.'),
  ...
  ('00000000-0000-0000-0000-000000000024', 'James Wilson',      'james@stark.io',             null,                'CEO',                   '00000000-0000-0000-0000-000000000005', ARRAY['00000000-0000-0000-0000-000000000014'], 'London, UK',        ARRAY['https://linkedin.com/in/jameswilson'],      ARRAY['ceo','decision-maker','manufacturing'], 'CEO of Stark Industries.'),
  ('00000000-0000-0000-0000-000000000025', 'Lisa Thompson',     'lisa@hooli.com',            '+1 (555) 456-7890', 'Procurement Manager',    '00000000-0000-0000-0000-000000000006', ARRAY['00000000-0000-0000-0000-000000000015'], 'Palo Alto, CA',     ARRAY['https://linkedin.com/in/lisathompson'],     ARRAY['procurement','tech'],          'Handles vendor evaluation.'),
  ('00000000-0000-0000-0000-000000000026', 'Robert Kim',        'robert@octocorp.com',       '+1 (555) 567-8901', 'Founder & CEO',          '00000000-0000-0000-0000-000000000007', ARRAY['00000000-0000-0000-0000-000000000016'], 'Seoul, South Korea', ARRAY['https://linkedin.com/in/robertkim'],        ARRAY['startup','ceo','tech'],        'Founder of OctoCorp.'),
  ('00000000-0000-0000-0000-000000000027', 'Amanda Foster',     'amanda@greenfield.com',       null,                'Data Science Lead',      '00000000-0000-0000-0000-000000000008', ARRAY['00000000-0000-0000-0000-000000000017'], 'Berlin, Germany',   ARRAY['https://linkedin.com/in/amandafoster'],     ARRAY['data','analytics','europe'],   'Leading the evaluation team.')
on conflict (id) do nothing;
